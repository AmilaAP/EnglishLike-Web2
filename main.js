document.addEventListener('DOMContentLoaded', () => {
    ...
    const savedTheme = localStorage.getItem('englishlike-theme') || 'light';
    ...
    if (themeToggle) {
        themeToggle.addEventListener('click', () => {
            ...
            localStorage.setItem('englishlike-theme', newTheme);
            applyTheme(newTheme);
        });
    }
    ...
    window.addEventListener('scroll', () => {
        ...
        if (navbar) {
            ...
            if (scrolled) {
                ...
                navbar.classList.add('shadow-lg', 'shadow-indigo-500/8');
                navbar.classList.remove('shadow-black/20');
                if (inner) inner.classList.replace('py-3', 'py-2');
            } else {
                navbar.style.background = '';
                navbar.classList.remove('shadow-lg', 'shadow-indigo-500/8');
